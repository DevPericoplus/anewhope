"""
Ejemplo de rxconfig.py con Redis para Frontend
Ubicación: src/apps/5_web_frontend/rxconfig.py

IMPORTANTE: Reflex 0.8.25 usa automáticamente Redis cuando se proporciona redis_url.
No requiere state_manager_mode ni otros parámetros adicionales.
"""
import reflex as rx
import sys
...
config = rx.Config(
    ...
    db_url="sqlite:///reflex.db",  # DB local para datos específicos de la app
