"""Visor de archivos Markdown para el panel inferior del backoffice."""
...
# Ruta de la página
@rx.page(route="/backoffice/show-md", title="Visor de Contenido", on_load=ShowMdState.on_page_load)
