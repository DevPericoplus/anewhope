...
def _setup_unified_logging(logs_dir: Path) -> tuple[logging.Handler, logging.Handler]:
    ...
    Returns:
        Tuple con (file_handler, console_handler) para reutilizar en uvicorn.
    """
...
def _configure_uvicorn_logging(
    ...
    # Configurar loggers de uvicorn para que usen nuestros handlers
    ...
    # Retornar configuración para uvicorn.run
    return {
        "version": 1,
...
def main() -> None:
    ...
    # Configurar handlers unificados
    ...
    # Configurar uvicorn para usar nuestros handlers
