"""Tema CRT verde fósforo — Frontend (GETmylllm)."""
...
COLORS: dict[str, str] = _crt_theme.get_portal_colors("green")
CRT_STYLESHEETS: list[str] = _crt_theme.CRTStylesheets["green"]
CRT_SHELL_CLASS: str = _crt_theme.CRT_SHELL_CLASS["green"]
